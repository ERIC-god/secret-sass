    ...
    return (
        <div className="w-full min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-[#23235b] via-[#29295e] to-[#23235b]">
            <div className="-mt-60 w-full max-w-lg bg-gradient-to-br from-[#23235b] via-[#29295e] to-[#23235b] rounded-2xl shadow-2xl border border-[#35356a] p-10">
                <h1 className="text-3xl font-extrabold text-white mb-8 text-center">Create Storage</h1>
                <form
                ...
                >
                    <div>
                        ...
                        />
                        <span className="text-pink-400 text-sm">{errors.name?.message}</span>
                    </div>
                    <div>
                        ...
                        />
                        <span className="text-pink-400 text-sm">{errors.bucket?.message}</span>
                    </div>
                    <div>
                        ...
                        />
                        <span className="text-pink-400 text-sm">{errors.accessKeyId?.message}</span>
                    </div>
                    <div>
                        ...
                        />
                        <span className="text-pink-400 text-sm">{errors.secretAccessKey?.message}</span>
                    </div>
                    <div>
                        ...
                        />
                        <span className="text-pink-400 text-sm">{errors.region?.message}</span>
                    </div>
                    <div>
                        ...
                        />
                        <span className="text-pink-400 text-sm">{errors.apiEndpoint?.message}</span>
                    </div>
                    <Button
                        type="submit"
